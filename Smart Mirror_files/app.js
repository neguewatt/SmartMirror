...
/*        return $http({
            method: 'JSONP',
            url: 'http://www.lemonde.fr/' + rubrique,
            dataType: 'xml',
        ...
        return $http.jsonp('//ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=50&callback=JSON_CALLBACK&q=' + encodeURIComponent('http://www.lemonde.fr/'+ rubrique));
